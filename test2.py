...
num_ants = 30
num_iterations = 200
decay = 0.90  # slightly lower decay for stronger pheromone retention
alpha = 1.5   # increased influence of pheromones
beta = 2.5    # increased influence of heuristic (distance)
...
print("Starting ACO optimization with updated parameters...")
